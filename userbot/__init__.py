...
UPSTREAM_REPO_URL = "https://github.com/UltroBot/UltroUserBot.git" #if not STABILITY else https://github.com/erdewbey/UltroUserBot.git Eski Dostum Berce'ye Aittir.
...
with bot:
    ...
    try:
        ...
        bot(JoinChannelRequest("@UltroBotChat"))
        bot(JoinChannelRequest("@ultroplugin"))
...
Hesabınızı bot'a çevirebilirsiniz ve bunları kullanabilirsiniz. Unutmayın, siz başkasının botunu yönetemezsiniz! Alttaki GitHub adresinden tüm kurulum detayları anlatılmıştır.""",
                    buttons=[
                        ...
                        [custom.Button.url(
                            "GitHub", "https://github.com/erdewbey/UltroUserBot")]
                    ],
                    link_preview=False
                )
